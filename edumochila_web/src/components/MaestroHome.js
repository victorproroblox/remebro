    ...
    <main className="mh">
      ...
      <section className="mh-hero">
        ...
        <div className="mh-hero__content">
          ...
          <h1 className="mh-hero__title">Panel del Maestro</h1>
          ...
          <div className="mh-hero__actions">
            <button
              ...
              onClick={() => go("/maestro/grupos")}
            >
              <MdGroups style={{ marginRight: 8 }} /> Mi salón
            </button>
            <button
              className="btn btn-outline"
              onClick={() => go("/maestro/avisos")}
            >
