...
CREATE TABLE `codigos` (
  ...
  UNIQUE KEY `uq_codigos_venta` (`id_ve`),
  CONSTRAINT `fk_codigos_ventas` FOREIGN KEY (`id_ve`) REFERENCES `ventas` (`id_ve`) ON DELETE CASCADE
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER codigos_productos
AFTER INSERT ON ventas
FOR EACH ROW
BEGIN
  DECLARE done INT DEFAULT 0;
  DECLARE gen_code CHAR(6);

  REPEAT
    SET gen_code = LPAD(FLOOR(RAND() * 1000000), 6, '0');
    INSERT IGNORE INTO codigos (id_ve, codigo)
    VALUES (NEW.id_ve, gen_code);
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER descuenta_stock
AFTER INSERT ON ventas
FOR EACH ROW
BEGIN
  CALL decrementar_stock(NEW.id_pr, 1);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
